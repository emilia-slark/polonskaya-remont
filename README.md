...
```
polonskaya-remont/
├── public/              # Статические активы (изображения, иконки, sitemap.xml)
├── src/
│   ├── api/             # Логика для взаимодействия с API
│   ├── assets/          # Ресурсы, используемые в коде (шрифты, svg-иконки)
│   ├── pages/           # Компоненты-страницы (Main, About, NotFound)
│   ├── styles/          # Глобальные стили, переменные и миксины SCSS
│   ├── ui/              # Переиспользуемые UI-компоненты
│   ├── utils/           # Вспомогательные функции и константы
│   ├── widgets/         # Крупные UI-блоки и секции страниц
